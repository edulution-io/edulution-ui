...
enum BulletinBoardErrorMessage {
  ...
  ATTACHMENT_UPLOAD_FAILED = 'bulletinboard.errors.attachmentUploadFailed',
  FILE_NOT_PROVIDED = 'bulletinboard.errors.fileNotProvided',
  FILE_NOT_FOUND = 'bulletinboard.errors.fileNotFound',
  INVALID_CATEGORY = 'bulletinboard.errors.invalidCategory',
  INVALID_FILE_TYPE = 'bulletinboard.errors.invalidFileType',
