...
const ExtendedOptionKeys = {
  ...
  CHAT_GROUP_CHAT_ENABLED: 'CHAT_GROUP_CHAT_ENABLED',
  CHAT_GROUP_CHAT_GROUPS: 'CHAT_GROUP_CHAT_GROUPS',
  CHAT_AI_CHAT_ENABLED: 'CHAT_AI_CHAT_ENABLED',
  CHAT_AI_CHAT_GROUPS: 'CHAT_AI_CHAT_GROUPS',
  CHAT_AI_SERVICES: 'CHAT_AI_SERVICES',
  CHAT_AI_ASSISTANT_TABLE: 'CHAT_AI_ASSISTANT_TABLE',
} as const;
