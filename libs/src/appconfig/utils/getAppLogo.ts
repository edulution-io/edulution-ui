...
export const getLogoUrlWithSurveyJSVariableTheme = () =>
  `/${EDU_API_ROOT}/${EDU_API_CONFIG_ENDPOINTS.FILES}/public/assets/${APPS.SURVEYS}/${APPS.SURVEYS}-custom-logo-{theme}.webp?fallback=${APPS.SURVEYS}-default-logo-{theme}.webp`;
