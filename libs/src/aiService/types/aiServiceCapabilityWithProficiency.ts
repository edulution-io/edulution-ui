...
interface AiServiceCapabilityWithProficiency {
  type: AiServiceCapabilityType;
  proficiency: AiServiceProficiencyType;
}

export default AiServiceCapabilityWithProficiency;
