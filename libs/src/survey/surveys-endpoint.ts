...
export const SURVEY_FIND_SURVEY_ENDPOINT = `${SURVEYS_ENDPOINT}${FIND_ONE_ENDPOINT}`;
export const SURVEY_FIND_SURVEYS_ENDPOINT = `${SURVEYS_ENDPOINT}${FIND_SURVEYS_ENDPOINT}`;
