...
const results = [
  {
    ...
    data: [
      {
        Quality: { affordable: '5', 'better then others': '5', 'does what it claims': '5', 'easy to use': '5' },
        satisfaction: 5,
        'recommend friends': 5,
      ...
      {
        Quality: { affordable: '3', 'does what it claims': '2', 'better then others': '2', 'easy to use': '3' },
        satisfaction: 3,
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        member_type_of_employment: ['Self-employed'],
...
export default class MockedSurveys {
  public defaultName = 'New Survey';
