...
describe('ToggleEditModeButton', () => {
  ...
  it('shows edit tooltip when not in edit mode', () => {
    render(
      <ToggleEditModeButton
        onClick={vi.fn()}
        isEditMode={false}
    ...
    expect(screen.getByTestId('window-control-btn')).toHaveAttribute('data-tooltip', 'common.edit');
  });

  it('shows view tooltip when in edit mode', () => {
    render(
      <ToggleEditModeButton
        onClick={vi.fn()}
        isEditMode
    ...
    expect(screen.getByTestId('window-control-btn')).toHaveAttribute('data-tooltip', 'common.view');
  });
