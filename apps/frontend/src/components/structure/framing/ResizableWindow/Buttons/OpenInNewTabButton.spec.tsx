...
describe('OpenInNewTabButton', () => {
  it('renders the button', () => {
    render(<OpenInNewTabButton onClick={vi.fn()} />);
  ...
  it('passes common.openInNewTab as tooltip translation id', () => {
    render(<OpenInNewTabButton onClick={vi.fn()} />);
    expect(screen.getByTestId('window-control-btn')).toHaveAttribute('data-tooltip', 'common.openInNewTab');
  });

  it('calls onClick when clicked', async () => {
    const user = userEvent.setup();
    const handleClick = vi.fn();
    render(<OpenInNewTabButton onClick={handleClick} />);
