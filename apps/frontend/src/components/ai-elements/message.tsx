...
import { ButtonGroup, ButtonGroupText } from '@/components/ai-elements/button-group';
        ...
        <>
          ...
          {onRemove && (
            <Button
              ...
              className="bg-background/80 absolute right-2 top-2 size-6 rounded-full p-0 opacity-0 backdrop-blur-sm transition-opacity group-hover:opacity-100 hover:bg-background [&>svg]:size-3"
              onClick={(e) => {
                e.stopPropagation();
                onRemove();
              }}
