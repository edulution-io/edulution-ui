...
import { HoverCard, HoverCardContent, HoverCardTrigger } from '@/components/ai-elements/hover-card';
import { Button } from '@/components/ai-elements/button';
import { DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from '@/components/ui/DropdownMenuSH';
import { InputGroup, InputGroupAddon, InputGroupButton, InputGroupTextarea } from './input-group';
import DropdownMenu from '@/components/shared/DropdownMenu';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ai-elements/select';
import { Command } from '@/components/ai-elements/command';
import {
  CommandEmpty,
  CommandGroup,
  CommandInput,
  ...
  return (
    <PromptInputHoverCard>
      <HoverCardTrigger asChild>
        <div
          className={cn(
            'dark:hover:bg-accent/50 group relative flex h-8 cursor-pointer select-none items-center gap-1.5 rounded-md border border-border px-1.5 text-sm font-medium transition-all hover:bg-accent hover:text-accent-foreground',
            className,
          )}
          key={data.id}
          {...props}
...
export const PromptInputSelectTrigger = ({ className, ...props }: PromptInputSelectTriggerProps) => (
  <SelectTrigger
    className={cn(
      ...
      'aria-expanded:bg-accent aria-expanded:text-foreground hover:bg-accent hover:text-foreground',
      className,
    )}
    {...props}
  />
