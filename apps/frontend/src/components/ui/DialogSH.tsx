  ...
  ({ className, children, showCloseButton = true, variant = 'default', ...props }, ref) => (
    <DialogPortalSH>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          'fixed max-h-[90vh] overflow-auto left-[50%] top-[50%] z-50 grid w-full translate-x-[-50%] translate-y-[-50%] gap-4 rounded-xl border bg-white p-6 shadow-lg duration-200',
