    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          sheetVariants({ side, variant }), 'max-h-[90vh] overflow-auto', className)}
        {...props}
      >
        {children}
...
const SheetHeader = ({ className, variant, ...props }: SheetHeaderProps) => (
  <div
    className={cn(
      {'text-foreground color-black' : variant === 'primary'},
      {'text-background color-white' : variant === 'secondary' || variant === 'tertiary'},
