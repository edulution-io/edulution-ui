...
const SidebarArrowButton: React.FC<ArrowButtonProps> = ({ direction, onClick }) => {
  ...
  return (
    <button
      ...
      className={`relative z-50 w-full cursor-pointer ${borderClass} border-muted bg-secondary-foreground px-4 py-2 hover:bg-accent dark:bg-background dark:hover:bg-stone-900 md:block md:px-2`}
      onClick={onClick}
    >
