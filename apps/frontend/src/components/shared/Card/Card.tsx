...
const cardVariants = cva('shadow-lg', {
  variants: {
    variant: {
      ...
      tileSelected:
        'rounded m-1 flex h-32 w-32 flex-col items-center overflow-hidden bg-ciGreenToBlue text-white transition-transform duration-300 hover:scale-105 md:w-48',
    },
  },
  defaultVariants: {
