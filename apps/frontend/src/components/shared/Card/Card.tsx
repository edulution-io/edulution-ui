...
const cardVariants = cva('shadow-lg', {
  variants: {
    variant: {
      ...
      tile: 'm-1 flex h-32 w-32 flex-col items-center overflow-hidden bg-glass border-white dark:border-black transition-transform duration-300 hover:scale-105 md:w-48',
      tileSelected:
        'm-1 flex h-32 w-32 flex-col items-center overflow-hidden bg-ciGreenToBlue text-white transition-transform duration-300 hover:scale-105 md:w-48',
    },
  },
  defaultVariants: {
