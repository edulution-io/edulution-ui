...
import LicenseInfoList from '@/pages/Licensing/Overview/LicenseInfoList';
...
const LicenseInfoPage = () => {
  ...
  return (
    <div className="p-5 lg:pr-20">
      ...
      <div className="absolute right-20 flex translate-y-20 flex-row items-center space-x-8 bg-opacity-90">
        <Button
          type="button"
          variant="btn-outline"
          onClick={() => {
