...
const MailProxiesField = (props: UserSettingsDetailsFormProps) => {
  ...
  return (
    <FormFieldSH
      ...
      render={() => (
        <FormItem>
          <div className={cn({ 'flex flex-row gap-2': !isMobileView }, { 'space-y-2': isMobileView })}>
            <p className={cn({ 'flex-0 w-[200px]': !isMobileView }, 'font-bold')}>
              {t('usersettings.details.proxyAddresses')}:
            </p>
