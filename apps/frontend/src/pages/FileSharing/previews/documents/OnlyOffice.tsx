  ...
  useEffect(() => {
    ...
    const fetchFileUrlAndToken = async () => {
      try {
        ...
        const formattedUrl = rawUrl.replace('http://localhost:3000', 'http://host.docker.internal:3000');
        ...
        const config = {
          ...
          editorConfig: {
            callbackUrl: 'http://host.docker.internal:3000/edu-api/filemanager/callback',
            mode: mode,
          },
        };
