...
import type { MailDto, MailProviderConfigDto, CreateSyncJobDto, SyncJobDto } from '@libs/mail/types';
import type MailsStore from '@libs/frontend/mail/types/mailsStore';
