...
type UserAdministrationFormValues = {
...
const UserAdministration: React.FC = () => {
  ...
  const form = useForm<UserAdministrationFormValues>({ defaultValues: { selectedUsers: [] } });
  ...
  const onSubmit = async (data: UserAdministrationFormValues) => {
