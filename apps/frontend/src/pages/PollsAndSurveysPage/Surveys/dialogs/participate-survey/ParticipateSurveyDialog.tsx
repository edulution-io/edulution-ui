...
import useParticipateSurveyDialogStore from '@/pages/PollsAndSurveysPage/Surveys/dialogs/participate-survey/ParticipateSurveyDialogStore';
import ParticipateSurveyFormData from '@/pages/PollsAndSurveysPage/Surveys/dialogs/participate-survey/participate-survey-form';
import ParticipateSurveyDialogBody from '@/pages/PollsAndSurveysPage/Surveys/dialogs/participate-survey/ParticipateSurveyDialogBody';
...
const ParticipateSurveyDialog = (props: ParticipateSurveyDialogProps) => {
  ...
  const { isAnswering, commitAnswer, error } = useParticipateSurveyDialogStore();
