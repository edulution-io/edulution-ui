...
import FloatingButtonParticipatePoll
  from '@/pages/PollsAndSurveysPage/Polls/components/floating-buttons/Participate';
import FloatingButtonOpenPollResults
  from '@/pages/PollsAndSurveysPage/Polls/components/floating-buttons/OpenResults';
...
const FloatingButtonsBarPollManagement = (props: FloatingButtonsBarPollManagementProps) => {
  ...
  const AddButton = (
    <FloatingButtonCreatePoll setSelectedPoll={ setSelectedPoll } openEditPollDialog={ openEditPollDialog } />
  )
  ...
  const getOtherButtons = () => {
    switch (selectedType) {
      ...
      case UsersPollsTypes.ANSWERED:
        return (
          <FloatingButtonOpenPollResults openPollResultsDialog={openPollResultsDialog}/>
        );
      default:
        return null;
    }
