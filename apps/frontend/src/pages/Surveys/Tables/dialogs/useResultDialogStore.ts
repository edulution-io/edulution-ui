...
import { SURVEY_RESULT_ENDPOINT } from '@libs/survey/constants/api/surveys-endpoint';
import ResultDialogStoreInitialState from '@libs/survey/constants/tables/dialogs/resultDialogStoreInitialState';
