...
const surveyTheme: ITheme = {
  cssVariables: {
    ...
    '--sjs-font-surveytitle-color': 'var(--input)',
    '--sjs-font-editorfont-color': 'var(--background)',
    '--sjs-font-pagetitle-color': 'var(--ring)',
    '--sjs-font-pagedescription-color': 'var(--background)',
    '--sjs-questionpanel-backcolor': 'var(--card-background)',
    '--sjs-questionpanel-backcolor-light': 'var(--card-background)',
    '--sjs-questionpanel-backcolor-dark': 'var(--card-background)',
